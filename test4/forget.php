...
<body class="fp-page">
    <div class="fp-box">
        <div class="logo">
            <a href="javascript:void(0);">Project<b></b></a>
            <small>Admin Reset password</small>
        </div>
        <div class="card">
            <div class="body">
			<?php
                ...
                <form action="controller/forgetPassword.php" method="POST" id="checkLogin" >
                    ...
                    <button class="btn btn-block btn-lg bg-pink waves-effect" type="submit" name="btn_submit">RESET MY PASSWORD</button>
